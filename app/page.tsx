...
export default function Home() {
  ...
  return (
    <main className="contenedor">
      ...
      <p className="nota" style={{ fontSize: 18, maxWidth: 520, color: "var(--tinta)" }}>
        No le damos la respuesta: lo guiamos a descubrirla, como un buen profe. Y tú ves desde
      ...
      <div className="stats">
        <div className="stat">
          <div className="num">15<span className="unidad"> min</span></div>
      ...
      <section className="seccion">
        ...
        <p className="seccion-intro">
          La hora de la tarea no debería terminar en lágrimas ni en peleas. Tampoco en
          copiar respuestas de internet sin entender nada.
        </p>
      ...
      <section className="seccion">
        ...
        <div className="tarjeta">
          <div className="paso">
            ...
            <div>
              <h4>Sube la tarea</h4>
              <p>El niño toma una foto de la tarea o escribe la pregunta que no entiende.</p>
            </div>
          </div>
          <div className="paso">
      ...
      <section className="seccion">
        ...
        <div className="rejilla">
          <div className="beneficio">
            ...
            <p>Método socrático: razona y entiende el porqué, no memoriza el resultado.</p>
          </div>
          <div className="beneficio">
            <span className="emoji">📊</span>
            <h4>Reportes para ti</h4>
            <p>Ves su progreso por tema y recibes resúmenes por WhatsApp cada semana.</p>
          </div>
          <div className="beneficio">
            <span className="emoji">🛡️</span>
            <h4>Entorno seguro</h4>
            <p>Solo matemáticas de primaria. Sin chats con extraños, sin anuncios.</p>
          </div>
          <div className="beneficio">
            <span className="emoji">🎯</span>
          ...
          <div className="beneficio">
            ...
            <p>Deja de tenerle miedo a las mates y se siente capaz de hacerlo solo.</p>
          </div>
          <div className="beneficio">
            <span className="emoji">🕊️</span>
